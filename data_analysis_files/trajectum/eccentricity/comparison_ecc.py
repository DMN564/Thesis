...
x_in, _, y_in, x_in_err, y_in_err = get_histograms("/home/dahamvin/3. Trajectum_Plots/Comparison_Plots/30_50_Eccentricity/data/P_t_50_In_Plane_Initial")[0]
x_out, _, y_out, x_out_err, y_out_err = get_histograms("/home/dahamvin/3. Trajectum_Plots/Comparison_Plots/30_50_Eccentricity/data/P_t_50_Out_Plane_Initial")[0]
x_all,  _, y_all,  _, y_all_err  = get_histograms("/home/dahamvin/3. Trajectum_Plots/Comparison_Plots/30_50_Eccentricity/data/P_t_50")[0]

aos = yoda.read("rivet_hydro_merged.yoda")
N_all    = aos["/MC_TRAJECTUM_PT/N_EVENTS"].numEntries()
N_highEcc = aos["/MC_TRAJECTUM_PT/N_EVENTS_HIGH_ECC"].numEntries()
N_lowEcc  = aos["/MC_TRAJECTUM_PT/N_EVENTS_LOW_ECC"].numEntries()
...
def main():
    ...
    ax1.set_title(r'Jet Spectra: 30-50% Centrality In-Plane vs Out-of-Plane (High and Low Eccentricity)',fontsize=12)
    fig.tight_layout()
    fig.savefig('/home/dahamvin/3. Trajectum_Plots/Comparison_Plots/30_50_Eccentricity/Jet_Comparison_30_50_All_ecc.png', dpi=300, bbox_inches='tight')
    plt.show()
